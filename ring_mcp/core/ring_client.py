...
from .exceptions import RingError, AuthenticationError, DeviceNotFoundError, StreamingError
...
class RingClient:
    ...
    def arm_system(self, mode: str, bypass_sensors: List[str] = None, 
                   entry_delay_minutes: Optional[int] = None) -> Dict[str, Any]:
    ...
    def disarm_system(self, force: bool = False, disarm_code: Optional[str] = None) -> Dict[str, Any]:
    ...
    def get_events_history(self, start_time: datetime, end_time: datetime, 
    ...
    def start_live_stream(self, device_id: str, quality_settings: Dict[str, Any], 
    ...
    def answer_call(self, call_id: str, enable_two_way_audio: bool = True, 
                   record_conversation: bool = True) -> Dict[str, Any]:
    ...
    def get_doorbell_events(self, device_id: str, start_time: datetime, 
                           end_time: datetime, motion_only: bool = False) -> List[Dict[str, Any]]:
        """Get doorbell events."""
        return []

...
4. Start the server:
   ...
   uv run python -m ring_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn ring_mcp.server:app --port 10728
   ```
5. Open `http://localhost:10728` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/ring-mcp/issues) |

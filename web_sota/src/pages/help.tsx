            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card className="border-slate-800 bg-slate-950/50">
                    ...
                    <CardContent className="text-sm text-slate-400 space-y-4">
                        <p>This MCP server provides a standardized interface for Ring Home Security operations. It allows for motion monitoring, doorbell interaction, and security mode management.</p>
                        <p>Key concepts:</p>
